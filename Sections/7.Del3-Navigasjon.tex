...
\begin{itemize}
    \item \textbf{Brødsmulesti:} Sidene har brødsmulesti, men den er ikke
...
individuelle innholdssider. Hierarkiet bestemmer hvordan brødsmulestien
...
\begin{figure}[H]
    ...
    \caption{Sidehierarki -- navigasjonsstruktur fra forside til
             innholdssider, med eksempel på brødsmulesti.}
...
Brødsmulestien reflekterer dette hierarkiet direkte, slik som vist i
...
Brødsmulestien på helsedirektoratet.no viser stien tilbake til forsiden,
men har noen begrensninger: lange sidetitler avskjæres uten visuell
tilbakemelding, og på sider med mer enn tre nivåer i hierarkiet kan stien
bli uoversiktlig lang. Det finnes ingen funksjonalitet for å kollapse
mellomliggende ledd ved svært dype stier.
