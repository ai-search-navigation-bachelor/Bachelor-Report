...
Helsedirektoratet stilte til rådighet data fra en intern brukerundersøkelse gjennomført på helsedirektoratet.no i perioden 15.–29.\ september 2025. Undersøkelsen ble gjennomført ved hjelp av verktøyet Skyra, som lar besøkende besvare korte spørreskjema direkte på nettsiden underveis i besøket. Totalt besvarte 3\,747 respondenter undersøkelsen, noe som gir en svarrate på 2,9~\%. En svarrate mellom 1 og 5~\% regnes som normalt for denne typen nettstedsundersøkelse.
...
\begin{figure}[H]
    ...
    \caption{Skyra-undersøkelsen slik den ble presentert for besøkende på helsedirektoratet.no i september 2025.}
...
I tillegg til å benytte Helsedirektoratets eksisterende data, gjennomførte prosjektgruppen en egen spørreundersøkelse for å innhente supplerende brukerinnsikt. Opprinnelig var planen å distribuere undersøkelsen via Skyra, på samme måte som Helsedirektoratets egne undersøkelser. Dette lot seg imidlertid ikke gjennomføre innenfor prosjektets tidsramme, og undersøkelsen ble i stedet distribuert digitalt i samarbeid med Helsedirektoratet gjennom virksomhetens interne kommunikasjonskanaler. Figur~\ref{fig:christine-promotering} viser et eksempel på hvordan undersøkelsen ble delt internt, der en representant fra Helsedirektoratet oppfordret ansatte til å bidra.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Images/spørreundersøkelse/christine-undersøkelse}
    \caption{Intern deling av prosjektgruppens spørreundersøkelse via Helsedirektoratets kommunikasjonskanaler.}
